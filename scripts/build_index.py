...
from org.apache.lucene.document import StringField, NumericDocValuesField, DoubleDocValuesField
    ...
    def indexDocs(self, root, writer):
        ...
        with open(root, 'r') as tsv:
            for row in tsv.readlines()[1:]:
                ...
                self.add_elements(doc, row[6], "genre", TextField)
                ...
                doc.add(DoubleDocValuesField("imdb_rating_boost", self.parse_float(row[12])))
                ...
                self.add_elements(doc, row[-4], "language", TextField)
                self.add_elements(doc, row[-3], "country", TextField)
