...
if PRODUCTION:
    DATABASES = {
        ...
        'USER': os.environ.get("FILMYOU_DB_USER", ''),
...
SECRET_KEY = '&7o$cz@3_u5^b!*r=*v-nt+w=_v-f@guw2s54_9#!z7=_#4l1&'
...
ROOT_URLCONF = 'filmyou.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'filmyou.wsgi.application'
